...
const styles = {
    ...
    common: 'inline-flex items-center justify-center border rounded-lg transition-colors cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500',
    primary: {
        base: 'text-white bg-blue-600 border-blue-400 hover:bg-blue-700',
        disabled:
            'text-white bg-gray-400 border-gray-400 pointer-events-none opacity-50'
    },
    secondary: {
        base: 'text-black bg-white border-gray-200 hover:bg-gray-200',
        disabled:
            'text-black bg-gray-100 border-gray-100 pointer-events-none opacity-50'
    },
    tertiary: {
        base: 'text-black bg-transparent border-transparent hover:bg-gray-200',
        disabled:
            'text-gray-900 bg-transparent border-transparent pointer-events-none opacity-50'
    },
    text: {
        base: 'text-blue-600 bg-transparent border-transparent hover:text-blue-700 hover:underline',
        disabled:
            'text-blue-900 bg-transparent border-transparent pointer-events-none opacity-50'
    },
    none: {
...
const componentStyle = computed(() => {
    ...
    return `${styles.common} ${styles.padding[size]} ${visual}`
})
</script>
